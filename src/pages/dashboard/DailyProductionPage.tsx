    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const savingToast = toast.loading(
                ...
                {
                    description: 'Registrando producción diaria en el sistema.'
                }
            )
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => {
                            ...
                            toast.info('Historial del día', {
                                description: `Se encontraron ${dailyHistory.length} registros cargados hoy.`
                            })
                        }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-card p-6 rounded-2xl border border-border shadow-sm">
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                value={typeSchedule}
                                onChange={(e) =>
                                    setTypeSchedule(e.target.value as any)
                                }
                            >
                                <option value="Normal">
                                    Normal
                                            ...
                                            {measures.map((m) => (
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        value={
                                                            matrix[`${p.productID}-${m.measureID}`] || ""
                                                        }
                                                        onChange={(e) =>
                                                            handleInputChange(
                                                                p.productID,
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1">
                                Producción registrada en la jornada actual.
                            </p>
                        </div>
